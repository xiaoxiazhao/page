(function(){
    ...
    function loadLaifeng() {
        ...
        if(ele.scrollTop+800>_top) {
            _isRequest = true;
            xmloadingjs('http://www.laifeng.com/cms/youku/home_channel',function(){
                readData();
            });
        }
    }
    ...
    function readData() {
        ...
        var html = '<div class="yk-row-index"><div class="yk-row">';
        //左侧
        html+='<div class="yk-w970-col12 yk-w1190-col16"><div class="yk-box">';
        html+='<div class="yk-head">'+
                '<div class="yk-title">'+
                    '<span>'+
                        '<a target="_blank" href="http://www.laifeng.com/anchor/search">来疯互动直播</a>'+
                    '</span>'+
                '</div>'+
            '</div>';
        ...
        html+='</div></div>';
        //右侧
        html+='<div class="yk-col6"><div class="yk-box"><div class="yk-head"></div><div class="yk-body">';
        html+=loadRank(data,4)+'</div></div></div>';
        //
        html+='</div></div>';
