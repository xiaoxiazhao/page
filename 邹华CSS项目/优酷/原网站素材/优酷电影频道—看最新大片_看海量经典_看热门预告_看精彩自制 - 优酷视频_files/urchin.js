...
function urchinTracker(videoCategory, page) {
	...
	//{{{ Í³¼ÆÓÃ»§ÆÁÄ»·Ö±æÂÊ¼°´°¿Ú³ß´ç JIRA-12020
	//_logUserScreen();
	//}}}
	_yfns=0;
	_yfno=0;
...
function _yInfo(videoCategory, page) {
	...
	if ((_yserv==1 || _yserv==2) && _ySP()) {
		...
		if(typeof(window.livelog)!='undefined' &&　typeof(window.livelog.liveid)!='undefined'){
			var liveStat ={};
...
function _logUserScreen (){
	...
	if (window.innerWidth){
		// ±ê×¼ä¯ÀÀÆ÷ FF Chrome Opera Safari
